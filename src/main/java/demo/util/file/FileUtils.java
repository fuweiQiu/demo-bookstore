...
import demo.exception.file.FileExtensionNotFoundException;
import demo.exception.file.InvalidCharsetException;
import demo.exception.file.InvalidOptionException;
import demo.exception.file.UnauthorizedException;
...
public class FileUtils {
    ...
    public Path getFilePath(@NonNull String filePath) {
        try {
            ...
            throw new demo.exception.file.InvalidPathException(e, filePath);
        }
    }
    ...
    public Path getDirectoryPath(@NonNull String firstDirectoryPath, String... subDirectoryPath) {
        try {
            ...
            throw new demo.exception.file.InvalidPathException(e, firstDirectoryPath, subDirectoryPath);
        }
    }
